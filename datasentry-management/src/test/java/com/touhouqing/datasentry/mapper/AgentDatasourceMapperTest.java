...
public class AgentDatasourceMapperTest {
	...
	public void testAgentDatasourceCreateNewRelationEnabled() {
		...
		Long datasourceId = createTestDatasourceAndGetId();
	...
	public void testAgentDatasourceSelectByAgentId() {
		// Given
		Long agentId = this.agentId;
		Long datasourceId1 = createTestDatasourceAndGetId();
		Long datasourceId2 = createTestDatasourceAndGetId();
	...
	public void testAgentDatasourceCountActiveByAgentIdExcluding() {
		...
		Long datasourceId1 = createTestDatasourceAndGetId();
		Long datasourceId2 = createTestDatasourceAndGetId();
		Long datasourceId3 = createTestDatasourceAndGetId();
	...
	private Long createTestAgentAndGetId() {
		...
		jdbcTemplate.update(con -> {
			var ps = con.prepareStatement(
					"INSERT INTO datasentry_agent (name, description, status, category) VALUES (?, ?, 'published', 'test')",
		...
		Long exists = jdbcTemplate.queryForObject("SELECT COUNT(1) FROM datasentry_agent WHERE id = ?", Long.class, id);
