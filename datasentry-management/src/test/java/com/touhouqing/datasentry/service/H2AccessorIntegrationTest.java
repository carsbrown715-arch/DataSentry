...
public class H2AccessorIntegrationTest {
	...
	public void setUp() {
		...
		dbConfig.setUrl(
				"jdbc:h2:mem:datasentry_database;DB_CLOSE_DELAY=-1;DATABASE_TO_LOWER=true;MODE=MySQL;DB_CLOSE_ON_EXIT=FALSE");
	...
	public void testFetchTables() throws Exception {
		DbQueryParameter queryParam = DbQueryParameter.from(dbConfig);
		queryParam.setSchema("public");
		queryParam.setTables(List.of("datasentry_datasource"));
	...
	public void testShowColumns() throws Exception {
		DbQueryParameter queryParam = DbQueryParameter.from(dbConfig);
		queryParam.setSchema("public");
		queryParam.setTable("datasentry_datasource");
	...
	public void testShowForeignKeys() throws Exception {
		DbQueryParameter queryParam = DbQueryParameter.from(dbConfig);
		queryParam.setSchema("public");
		queryParam.setTables(List.of("datasentry_agent_datasource", "datasentry_agent"));
	...
	public void testExecuteSqlAndReturnObject() throws Exception {
		DbQueryParameter queryParam = DbQueryParameter.from(dbConfig);
		queryParam.setSchema("public");
		queryParam.setSql("select count(*) from datasentry_datasource");
