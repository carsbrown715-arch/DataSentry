...
import static com.touhouqing.datasentry.prompt.PromptHelper.buildSemanticModelPrompt;
...
import com.touhouqing.datasentry.service.nl2sql.Nl2SqlService;
import com.touhouqing.datasentry.service.schema.SchemaService;
import com.touhouqing.datasentry.service.semantic.SemanticModelService;
import com.touhouqing.datasentry.util.ChatResponseUtil;
import com.touhouqing.datasentry.util.DatabaseUtil;
...
public class TableRelationNode implements NodeAction {
	...
	private List<String> getLogicalForeignKeys(Long agentId, List<Document> tableDocuments) {
		try {
			...
			Long datasourceId = agentDatasource.getDatasourceId();
