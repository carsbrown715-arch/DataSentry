 ...
 */
package com.touhouqing.datasentry.config;
...
import com.touhouqing.datasentry.properties.CodeExecutorProperties;
import com.touhouqing.datasentry.properties.DataSentryProperties;
import com.touhouqing.datasentry.properties.FileStorageProperties;
import com.touhouqing.datasentry.service.aimodelconfig.AiModelRegistry;
import com.touhouqing.datasentry.service.vectorstore.SimpleVectorStoreInitialization;
import com.touhouqing.datasentry.splitter.ParagraphTextSplitter;
import com.touhouqing.datasentry.splitter.SemanticTextSplitter;
import com.touhouqing.datasentry.splitter.SentenceSplitter;
import com.touhouqing.datasentry.strategy.EnhancedTokenCountBatchingStrategy;
import com.touhouqing.datasentry.util.McpServerToolUtil;
import com.touhouqing.datasentry.util.NodeBeanUtil;
import com.touhouqing.datasentry.workflow.dispatcher.FeasibilityAssessmentDispatcher;
import com.touhouqing.datasentry.workflow.dispatcher.HumanFeedbackDispatcher;
import com.touhouqing.datasentry.workflow.dispatcher.IntentRecognitionDispatcher;
import com.touhouqing.datasentry.workflow.dispatcher.PlanExecutorDispatcher;
import com.touhouqing.datasentry.workflow.dispatcher.PythonExecutorDispatcher;
import com.touhouqing.datasentry.workflow.dispatcher.QueryEnhanceDispatcher;
import com.touhouqing.datasentry.workflow.dispatcher.SQLExecutorDispatcher;
import com.touhouqing.datasentry.workflow.dispatcher.SchemaRecallDispatcher;
import com.touhouqing.datasentry.workflow.dispatcher.SemanticConsistenceDispatcher;
import com.touhouqing.datasentry.workflow.dispatcher.SqlGenerateDispatcher;
import com.touhouqing.datasentry.workflow.dispatcher.TableRelationDispatcher;
import com.touhouqing.datasentry.workflow.node.EvidenceRecallNode;
import com.touhouqing.datasentry.workflow.node.FeasibilityAssessmentNode;
import com.touhouqing.datasentry.workflow.node.HumanFeedbackNode;
import com.touhouqing.datasentry.workflow.node.IntentRecognitionNode;
import com.touhouqing.datasentry.workflow.node.PlanExecutorNode;
import com.touhouqing.datasentry.workflow.node.PlannerNode;
import com.touhouqing.datasentry.workflow.node.PythonAnalyzeNode;
import com.touhouqing.datasentry.workflow.node.PythonExecuteNode;
import com.touhouqing.datasentry.workflow.node.PythonGenerateNode;
import com.touhouqing.datasentry.workflow.node.QueryEnhanceNode;
import com.touhouqing.datasentry.workflow.node.ReportGeneratorNode;
import com.touhouqing.datasentry.workflow.node.SchemaRecallNode;
import com.touhouqing.datasentry.workflow.node.SemanticConsistencyNode;
import com.touhouqing.datasentry.workflow.node.SqlExecuteNode;
import com.touhouqing.datasentry.workflow.node.SqlGenerateNode;
import com.touhouqing.datasentry.workflow.node.TableRelationNode;
...
import static com.touhouqing.datasentry.constant.Constant.AGENT_ID;
import static com.touhouqing.datasentry.constant.Constant.COLUMN_DOCUMENTS__FOR_SCHEMA_OUTPUT;
import static com.touhouqing.datasentry.constant.Constant.DB_DIALECT_TYPE;
import static com.touhouqing.datasentry.constant.Constant.EVIDENCE;
import static com.touhouqing.datasentry.constant.Constant.EVIDENCE_RECALL_NODE;
import static com.touhouqing.datasentry.constant.Constant.FEASIBILITY_ASSESSMENT_NODE;
import static com.touhouqing.datasentry.constant.Constant.FEASIBILITY_ASSESSMENT_NODE_OUTPUT;
import static com.touhouqing.datasentry.constant.Constant.GENEGRATED_SEMANTIC_MODEL_PROMPT;
import static com.touhouqing.datasentry.constant.Constant.HUMAN_FEEDBACK_DATA;
import static com.touhouqing.datasentry.constant.Constant.HUMAN_FEEDBACK_NODE;
import static com.touhouqing.datasentry.constant.Constant.HUMAN_REVIEW_ENABLED;
import static com.touhouqing.datasentry.constant.Constant.INPUT_KEY;
import static com.touhouqing.datasentry.constant.Constant.INTENT_RECOGNITION_NODE;
import static com.touhouqing.datasentry.constant.Constant.INTENT_RECOGNITION_NODE_OUTPUT;
import static com.touhouqing.datasentry.constant.Constant.IS_ONLY_NL2SQL;
import static com.touhouqing.datasentry.constant.Constant.MULTI_TURN_CONTEXT;
import static com.touhouqing.datasentry.constant.Constant.NL2SQL_GRAPH_NAME;
import static com.touhouqing.datasentry.constant.Constant.PLAN_CURRENT_STEP;
import static com.touhouqing.datasentry.constant.Constant.PLAN_EXECUTOR_NODE;
import static com.touhouqing.datasentry.constant.Constant.PLAN_NEXT_NODE;
import static com.touhouqing.datasentry.constant.Constant.PLAN_REPAIR_COUNT;
import static com.touhouqing.datasentry.constant.Constant.PLAN_VALIDATION_ERROR;
import static com.touhouqing.datasentry.constant.Constant.PLAN_VALIDATION_STATUS;
import static com.touhouqing.datasentry.constant.Constant.PLANNER_NODE;
import static com.touhouqing.datasentry.constant.Constant.PLANNER_NODE_OUTPUT;
import static com.touhouqing.datasentry.constant.Constant.PYTHON_ANALYSIS_NODE_OUTPUT;
import static com.touhouqing.datasentry.constant.Constant.PYTHON_ANALYZE_NODE;
import static com.touhouqing.datasentry.constant.Constant.PYTHON_EXECUTE_NODE;
import static com.touhouqing.datasentry.constant.Constant.PYTHON_EXECUTE_NODE_OUTPUT;
import static com.touhouqing.datasentry.constant.Constant.PYTHON_FALLBACK_MODE;
import static com.touhouqing.datasentry.constant.Constant.PYTHON_GENERATE_NODE;
import static com.touhouqing.datasentry.constant.Constant.PYTHON_GENERATE_NODE_OUTPUT;
import static com.touhouqing.datasentry.constant.Constant.PYTHON_IS_SUCCESS;
import static com.touhouqing.datasentry.constant.Constant.PYTHON_TRIES_COUNT;
import static com.touhouqing.datasentry.constant.Constant.QUERY_ENHANCE_NODE;
import static com.touhouqing.datasentry.constant.Constant.QUERY_ENHANCE_NODE_OUTPUT;
import static com.touhouqing.datasentry.constant.Constant.REPORT_GENERATOR_NODE;
import static com.touhouqing.datasentry.constant.Constant.RESULT;
import static com.touhouqing.datasentry.constant.Constant.SCHEMA_RECALL_NODE;
import static com.touhouqing.datasentry.constant.Constant.SEMANTIC_CONSISTENCY_NODE;
import static com.touhouqing.datasentry.constant.Constant.SEMANTIC_CONSISTENCY_NODE_OUTPUT;
import static com.touhouqing.datasentry.constant.Constant.SQL_EXECUTE_NODE;
import static com.touhouqing.datasentry.constant.Constant.SQL_EXECUTE_NODE_OUTPUT;
import static com.touhouqing.datasentry.constant.Constant.SQL_GENERATE_COUNT;
import static com.touhouqing.datasentry.constant.Constant.SQL_GENERATE_NODE;
import static com.touhouqing.datasentry.constant.Constant.SQL_GENERATE_OUTPUT;
import static com.touhouqing.datasentry.constant.Constant.SQL_GENERATE_SCHEMA_MISSING_ADVICE;
import static com.touhouqing.datasentry.constant.Constant.SQL_REGENERATE_REASON;
import static com.touhouqing.datasentry.constant.Constant.SQL_RESULT_LIST_MEMORY;
import static com.touhouqing.datasentry.constant.Constant.TABLE_DOCUMENTS_FOR_SCHEMA_OUTPUT;
import static com.touhouqing.datasentry.constant.Constant.TABLE_RELATION_EXCEPTION_OUTPUT;
import static com.touhouqing.datasentry.constant.Constant.TABLE_RELATION_NODE;
import static com.touhouqing.datasentry.constant.Constant.TABLE_RELATION_OUTPUT;
import static com.touhouqing.datasentry.constant.Constant.TABLE_RELATION_RETRY_COUNT;
...
@Configuration
@EnableAsync
@EnableConfigurationProperties({ CodeExecutorProperties.class, DataSentryProperties.class,
		FileStorageProperties.class })
public class DataSentryConfiguration implements DisposableBean {
	...
	public SimpleVectorStoreInitialization simpleVectorStoreInitialization(SimpleVectorStore vectorStore,
			DataSentryProperties properties) {
		return new SimpleVectorStoreInitialization(vectorStore, properties);
	}

	@Bean
	@ConditionalOnMissingBean(BatchingStrategy.class)
	public BatchingStrategy customBatchingStrategy(DataSentryProperties properties) {
	...
	@Bean(name = "token")
	public TextSplitter textSplitter(DataSentryProperties properties) {
		DataSentryProperties.TextSplitter textSplitterProps = properties.getTextSplitter();
		DataSentryProperties.TextSplitter.TokenTextSplitterConfig config = textSplitterProps.getToken();
	 ...
	 */
	@Bean(name = "recursive")
	public TextSplitter recursiveTextSplitter(DataSentryProperties properties) {
		DataSentryProperties.TextSplitter textSplitterProps = properties.getTextSplitter();
		DataSentryProperties.TextSplitter.RecursiveTextSplitterConfig config = textSplitterProps.getRecursive();
	 ...
	 */
	@Bean(name = "sentence")
	public TextSplitter sentenceSplitter(DataSentryProperties properties) {
		DataSentryProperties.TextSplitter textSplitterConfig = properties.getTextSplitter();
		DataSentryProperties.TextSplitter.SentenceTextSplitterConfig sentenceConfig = textSplitterConfig.getSentence();
	 ...
	 */
	@Bean(name = "semantic")
	public TextSplitter semanticSplitter(DataSentryProperties properties, EmbeddingModel embeddingModel) {
		DataSentryProperties.TextSplitter textSplitterProps = properties.getTextSplitter();
		DataSentryProperties.TextSplitter.SemanticTextSplitterConfig config = textSplitterProps.getSemantic();
	 ...
	 */
	@Bean(name = "paragraph")
	public TextSplitter paragraphSplitter(DataSentryProperties properties) {
		DataSentryProperties.TextSplitter textSplitterProps = properties.getTextSplitter();
		DataSentryProperties.TextSplitter.ParagraphTextSplitterConfig config = textSplitterProps.getParagraph();
