...
import com.touhouqing.datasentry.entity.AgentPresetQuestion;
...
public interface AgentPresetQuestionMapper {
	...
	@Select("""
			SELECT * FROM datasentry_agent_preset_question
	 ...
	 */
	@Select("""
			SELECT * FROM datasentry_agent_preset_question WHERE id = #{id}
			""")
	AgentPresetQuestion selectById(@Param("id") Long id);

	@Insert("""
			INSERT INTO datasentry_agent_preset_question (agent_id, question, sort_order, is_active, create_time, update_time)
	...
	@Update("""
			<script>
			UPDATE datasentry_agent_preset_question
			<set>
	...
	@Delete("""
			DELETE FROM datasentry_agent_preset_question WHERE id = #{id}
			""")
	int deleteById(@Param("id") Long id);

	@Delete("""
			DELETE FROM datasentry_agent_preset_question WHERE agent_id = #{agentId}
			""")
