...
public class DocumentConverterUtil {
	...
	public static List<Document> convertColumnsToDocuments(Long datasourceId, List<TableInfoBO> tables) {
	 ...
	 */
	public static Document convertColumnToDocument(Long datasourceId, TableInfoBO tableInfoBO,
	 ...
	 */
	public static Document convertTableToDocument(Long datasourceId, TableInfoBO tableInfoBO) {
	...
	public static List<Document> convertTablesToDocuments(Long datasourceId, List<TableInfoBO> tables) {
