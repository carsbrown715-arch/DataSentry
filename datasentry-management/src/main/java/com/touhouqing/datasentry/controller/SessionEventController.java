...
import com.touhouqing.datasentry.service.chat.SessionEventPublisher;
...
public class SessionEventController {
	...
	public Flux<ServerSentEvent<SessionUpdateEvent>> streamSessionUpdates(@PathVariable Long agentId,
