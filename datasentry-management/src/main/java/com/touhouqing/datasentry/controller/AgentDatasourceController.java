...
import com.touhouqing.datasentry.dto.datasource.ToggleDatasourceDTO;
import com.touhouqing.datasentry.dto.datasource.UpdateDatasourceTablesDTO;
...
@Slf4j
@RestController
@RequestMapping("/api/datasentry/agent/{agentId}/datasources")
@CrossOrigin(origins = "*")
@AllArgsConstructor
public class AgentDatasourceController {
	...
	public ApiResponse<?> removeDatasourceFromAgent(@PathVariable Long agentId, @PathVariable Long datasourceId) {
		try {
