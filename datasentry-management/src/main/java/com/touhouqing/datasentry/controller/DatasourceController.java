...
import com.touhouqing.datasentry.dto.schema.CreateLogicalRelationDTO;
import com.touhouqing.datasentry.dto.schema.UpdateLogicalRelationDTO;
...
@Slf4j
@RestController
@RequestMapping("/api/datasentry/datasource")
@CrossOrigin(origins = "*")
@AllArgsConstructor
public class DatasourceController {
	...
	public List<String> getDatasourceTables(@PathVariable Long id) {
	 ...
	 */
	@DeleteMapping("/{id}")
	public ApiResponse deleteDatasource(@PathVariable Long id) {
		try {
			checkDatasourceExists(id);
	...
	public ApiResponse<List<String>> getTableColumns(@PathVariable Long id, @PathVariable String tableName) {
		try {
	...
	public ApiResponse<List<LogicalRelation>> getLogicalRelations(@PathVariable(value = "id") Long datasourceId) {
		try {
	...
	public ApiResponse<LogicalRelation> addLogicalRelation(@PathVariable(value = "id") Long datasourceId,
	...
	public ApiResponse<LogicalRelation> updateLogicalRelation(@PathVariable(value = "id") Long datasourceId,
			@PathVariable Long relationId, @RequestBody UpdateLogicalRelationDTO dto) {
		try {
			LogicalRelation logicalRelation = LogicalRelation.builder()
				.sourceTableName(dto.getSourceTableName())
				.sourceColumnName(dto.getSourceColumnName())
	...
	public ApiResponse<Void> deleteLogicalRelation(@PathVariable(value = "id") Long datasourceId,
	...
	public ApiResponse<List<LogicalRelation>> saveLogicalRelations(@PathVariable(value = "id") Long datasourceId,
	...
	private Datasource checkDatasourceExists(Long id) {
