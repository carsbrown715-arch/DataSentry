 ...
 */
package com.touhouqing.datasentry.service.chat;

import com.touhouqing.datasentry.vo.SessionUpdateEvent;
...
public class SessionEventPublisher {
	...
	private final Map<Long, AgentSessionSink> sinks = new ConcurrentHashMap<>();

	public Flux<ServerSentEvent<SessionUpdateEvent>> register(Long agentId) {
	...
	public void publishTitleUpdated(Long agentId, String sessionId, String title) {
		if (agentId == null) {
			return;
		}
	...
	private void cleanup(Long agentId, AgentSessionSink sink, SignalType signalType) {
