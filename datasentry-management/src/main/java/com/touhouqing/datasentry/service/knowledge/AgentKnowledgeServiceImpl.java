 ...
 */
package com.touhouqing.datasentry.service.knowledge;

import com.touhouqing.datasentry.enums.EmbeddingStatus;
import com.touhouqing.datasentry.enums.KnowledgeType;
import com.touhouqing.datasentry.converter.AgentKnowledgeConverter;
...
import com.touhouqing.datasentry.event.AgentKnowledgeDeletionEvent;
import com.touhouqing.datasentry.event.AgentKnowledgeEmbeddingEvent;
import com.touhouqing.datasentry.mapper.AgentKnowledgeMapper;
import com.touhouqing.datasentry.service.file.FileStorageService;
...
public class AgentKnowledgeServiceImpl implements AgentKnowledgeService {
	...
	@Override
	@Transactional
	public AgentKnowledgeVO updateKnowledge(Long id, UpdateKnowledgeDTO updateKnowledgeDto) {
		// 基础校验：根据 id 查询数据库
	...
	@Override
	public AgentKnowledgeVO updateKnowledgeRecallStatus(Long id, Boolean recalled) {
		// 查询知识
		AgentKnowledge knowledge = agentKnowledgeMapper.selectById(id);
		if (knowledge == null) {
			throw new RuntimeException("Knowledge not found.");
