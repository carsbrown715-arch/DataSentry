 ...
 */
package com.touhouqing.datasentry.service.schema;

import com.touhouqing.datasentry.connector.DbQueryParameter;
import com.touhouqing.datasentry.bo.schema.ForeignKeyInfoBO;
import com.touhouqing.datasentry.bo.schema.TableInfoBO;
...
import com.touhouqing.datasentry.connector.accessor.Accessor;
import com.touhouqing.datasentry.connector.accessor.AccessorFactory;
import com.touhouqing.datasentry.bo.DbConfigBO;
import com.touhouqing.datasentry.dto.datasource.SchemaInitRequest;
import com.touhouqing.datasentry.dto.schema.ColumnDTO;
import com.touhouqing.datasentry.dto.schema.SchemaDTO;
import com.touhouqing.datasentry.dto.schema.TableDTO;
import com.touhouqing.datasentry.service.vectorstore.AgentVectorStoreService;
import com.touhouqing.datasentry.service.vectorstore.DynamicFilterService;
...
import static com.touhouqing.datasentry.util.DocumentConverterUtil.convertColumnsToDocuments;
import static com.touhouqing.datasentry.util.DocumentConverterUtil.convertTablesToDocuments;
...
public class SchemaServiceImpl implements SchemaService {
	...
	private final DataSentryProperties dataAgentProperties;
	...
	public void buildSchemaFromDocuments(String agentId, List<Document> currentColumnDocuments,
		...
		Long datasourceId = mutableTableDocuments.stream()
	...
	@Override
	public Boolean schema(Long datasourceId, SchemaInitRequest schemaInitRequest) throws Exception {
	...
	protected void storeSchemaDocuments(Long datasourceId, List<Document> columns, List<Document> tables) {
	...
	protected void clearSchemaDataForDatasource(Long datasourceId) throws Exception {
		// 检查是否有文档需要删除
	...
	@Override
	public List<Document> getTableDocumentsByDatasource(Long datasourceId, String query) {
	...
	private void loadMissingTableDocuments(Long datasourceId, List<Document> tableDocuments,
	...
	private void loadMissingColDocForMissingTables(Long datasourceId, List<Document> curColDocs,
			List<String> missingTableNames) {
		// 加载缺失的列文档
	...
	@Override
	public List<Document> getTableDocuments(Long datasourceId, List<String> tableNames) {
		Assert.notNull(datasourceId, "DatasourceId cannot be null.");
	...
	@Override
	public List<Document> getColumnDocumentsByTableName(Long datasourceId, List<String> tableNames) {
		Assert.notNull(datasourceId, "DatasourceId cannot be null.");
		if (tableNames.isEmpty()) {
