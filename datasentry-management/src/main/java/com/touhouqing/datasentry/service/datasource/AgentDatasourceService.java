...
public interface AgentDatasourceService {
	...
	Boolean initializeSchemaForAgentWithDatasource(Long agentId, Long datasourceId, List<String> tables);
	...
	AgentDatasource addDatasourceToAgent(Long agentId, Long datasourceId);

	void removeDatasourceFromAgent(Long agentId, Long datasourceId);

	AgentDatasource toggleDatasourceForAgent(Long agentId, Long datasourceId, Boolean isActive);

	void updateDatasourceTables(Long agentId, Long datasourceId, List<String> tables);
